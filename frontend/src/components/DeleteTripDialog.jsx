...
export default function DeleteTripDialog({ isOpen, onClose, tripId, tripName, onDeleteSuccess }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("Trip collection deleted successfully");
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">Delete Trip Collection?</h2>
              ...
              <div className="bg-red-50 border border-red-200 rounded-2xl p-4 mb-6">
                <p className="text-sm text-red-900 leading-relaxed">
                  This will permanently delete <strong>"{tripName}"</strong> and all photos, videos, comments, likes, and related data inside it.
                </p>
              </div>
